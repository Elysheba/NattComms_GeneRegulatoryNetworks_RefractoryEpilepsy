#########################################@
## Assess conservation of modules - FCD 2b
...
modAname <- "Correlated genes in FCD 2b"
rpname <- "AMC"
...
varGenes <- focusOnScope(
  getBekBeids(analysisNames = "Variable genes in FCD 2b"),
  force = FALSE,
  scope = refscope)
...
save(toRet, file = here("Data/06_Modules/FCD2b/Conservation/FCD2b_AMC_Control_Conservation.rda"))
