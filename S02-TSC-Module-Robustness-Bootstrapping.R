...
load(here("Data/06_Modules/TSC/Module-Data/spearman-KeptProbes-TSC.rda"))
...
# if(file.exists(here("Data/06_Modules/TSC/Module-Data/LOO_TSC_Cluster.rda"))){
...
# }else{
  ...
  LOO.clusters %>% head
  save(LOO.clusters, file = here("Data/06_Modules/TSC/Module-Data/LOO_TSC_Cluster.rda"))
# }
#
#
# if(file.exists(here("Data/06_Modules/TSC/Module-Data/AdjacencyMatrix_BS_TSC.rda"))){
#   load(here("Data/06_Modules/TSC/Module-Data/AdjacencyMatrix_BS_TSC.rda"))
# }else{
  # Take Clusters and create adjacency matrix
  # Sum adjacency matrices to look at all permutations
  ...
  save(adj.matrix, file = here("Data/06_Modules/TSC/Module-Data/AdjacencyMatrix_BS_TSC.rda"))
# }
#
#
...
save(similarity.mat, mod.decision, junk.genes.out, junk.genes,junk.genes.thres,
     file = here("Data/06_Modules/TSC/Module-Data/Bootstrapping_Similarity_TSC.rda"))
