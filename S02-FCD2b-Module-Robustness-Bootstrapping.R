...
load(here("Data/06_Modules/FCD2b/Module-Data/spearman-KeptProbes-FCD2b.rda"))

sampleInfo <- sampleInfo %>%
  filter(PA_Diagnosis == "FCD 2b")  %>%
  mutate(log10_seizure_freq = log10(Seizure_Frequency_months))
d <- vg$E[colnames(corMat),sampleInfo$GS_RNASEQ_ID]
...
if(file.exists(here("Data/06_Modules/FCD2b/Module-Data/LOO_FCD2b_Cluster.rda"))){
  ...
  LOO.clusters %>% head
  save(LOO.clusters, file = here("Data/06_Modules/FCD2b/Module-Data/LOO_FCD2b_Cluster.rda"))
}


if(file.exists(here("Data/06_Modules/FCD2b/Module-Data/AdjacencyMatrix_BS_FCD2b.rda"))){
  load(here("Data/06_Modules/FCD2b/Module-Data/AdjacencyMatrix_BS_FCD2b.rda"))
}else{
  ...
  save(adj.matrix, file = here("Data/06_Modules/FCD2b/Module-Data/AdjacencyMatrix_BS_FCD2b.rda"))
}
#
#
...
save(similarity.mat, mod.decision, junk.genes.out, junk.genes,junk.genes.thres,
     file = here("Data/06_Modules/FCD2b/Module-Data/Bootstrapping_Similarity_FCD2b.rda"))
